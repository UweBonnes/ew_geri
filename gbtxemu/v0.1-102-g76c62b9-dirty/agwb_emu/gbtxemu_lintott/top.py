...
class elinks(agwb.Block):
    ...
    x__fields = {
        ...
        'din_ctrl':(0x4,18,(agwb.ControlRegister,
        {\
            'delay':agwb.BitField(4,0,False),\
            'bit_select':agwb.BitField(7,5,False),\
        })),
        'din_stat':(0x16,18,(agwb.StatusRegister,
        {\
            'delay_ready':agwb.BitField(0,0,False),\
        })),
        'downlink_mask':(0x28,(agwb.ControlRegister,)),
        'elink_clk_ena':(0x29,(agwb.ControlRegister,)),
    }
